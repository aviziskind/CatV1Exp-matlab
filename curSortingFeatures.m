function [featureNames_out, featureNs_out, feature_str_out, featureNamesAndN_out] = curSortingFeatures(varargin)
...
%     [pts_i, pts] = curfeatures;
    ...
    filename = [CatV1Path 'MatLabDB_avi' filesep 'curSortingFeaturesFile.mat'];
    ...
    if setType   % set current feature
        ...
        for fet_i = 1:nFeatures
            ...
            if ~validPrefix
                error([fet_i_name ' is not a valid sorting feature']);
            end                        
