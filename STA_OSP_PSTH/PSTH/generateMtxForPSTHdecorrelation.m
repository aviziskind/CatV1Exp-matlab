function A = generateMtxForPSTHdecorrelation(frameStimIds, nFramesPerExtFrame, r_framesToConsider)
    % Generates the matrix for PSTH decorrelation

    showAllWorking = false;
